...
// Adapted for local use by Renaud Pawlak - Amaris
...
declare namespace d3 {
    ...
    export function scaleLinear(): scale.Linear<any, any>;
    ...
    interface Selection<Datum> {
        ...
        //domain(domain: number[]): Selection<any>;

        //range(range: String[]): Selection<any>;

        //interpolate(t): Selection<any>;
    ...
    interface Transition<Datum> {
        ...
        tween(name: string, factory: (d?: Datum) => (t: number) => any): Transition<Datum>;
        ...
        on(event: string, listener: (d: Datum) => any): Transition<Datum>;
    ...
    //namespace layout {
        ...
        export function hierarchy(d): Hierarchy<hierarchy.Result>;
        ...
        interface Hierarchy<T extends hierarchy.Result> {
            ...
            sum(sum: (a : T) => number): Hierarchy<T>;
        ...
        export function pack(): Pack<pack.Node<any>>;
        export function pack<T extends pack.Node<any>>(): Pack<T>;
        ...
        namespace pack {
            ...
            interface Link<T extends Node<any>> {
                source: T;
                target: T;
            }
        }

        interface Pack<T extends pack.Node<any>> {
            (root: T): T;
